    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Родитель', to='movies.review')),
            ],
            options={
                'verbose_name': 'Отзыв',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Звезда', to='movies.ratingstar')),
            ],
            options={
