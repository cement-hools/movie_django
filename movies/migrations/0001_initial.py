# Generated by Django 3.1.7 on 2021-07-10 13:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=2020, verbose_name='Год выхода')),
                ...
                ('actors', models.ManyToManyField(related_name='films_actor', to='movies.Actor', verbose_name='Актеры')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='movies', to='movies.category', verbose_name='Категория')),
                ('directors', models.ManyToManyField(related_name='films_director', to='movies.Actor', verbose_name='Режисер')),
                ('genres', models.ManyToManyField(related_name='films', to='movies.Genre', verbose_name='Жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Имя')),
                ('text', models.TextField(max_length=5000, verbose_name='Обзор')),
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comment', to='movies.review', verbose_name='Родитель')),
            ],
            options={
                'verbose_name': 'Отзыв',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='movies.ratingstar', verbose_name='Звезда')),
            ],
            options={
